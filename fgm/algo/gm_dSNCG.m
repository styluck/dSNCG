function asg = gm_dSNCG(K, asgT, opts)
% Graph matching using dual semi-Newton conjugate gradient method
%
% Input
...
for i =1:lmxitr
    ...
    [~,gapk,X_tmp,iter] = dSNCG_QAPBB(X0,retr,hfun,opts,K, Ksnorm, n, r );
