function asg = gm_Spenalty(K, asgT, opts)
% Graph matching using SEMI-SMOOTH penalty method with BB steps
%
% Input
...
for i =1:lmxitr
    ...
    X0 = randn(n);    
    X0 = orth(X0);
    %X0 = OptStiefelGBB(X0, @objfun_QAP,subopts,K,n,r,opts.objX);
    [fobj,X_tmp] = Spenalty_BB(X0,retr,sqhfun,hfun,opts,K,n,r);
